...
TODO: Write the remaining parts
...
and also see the fortune-service running:

k3d: `kubectl -n syn-tutorial port-forward svc/fortune-service 8081:3000`

`curl http://localhost:8081`

minikube: `minikube service fortune-service --namespace syn-tutorial`

`curl $(minikube service fortune-service --namespace syn-tutorial --url)`
