...
:keywords: VSHN, VSHNeer, work, systems, DevOps, Project Syn
:lang: en
...
. `git push`
. `cd ../[$TENANT_ID]`
** This folder is a clone of the `tutorial-tenant` project in your GitLab account.
...
. And then `curl http://localhost:8081` in a different terminal.
